...
function switchSection(fromId, toId) {
    ...
    setTimeout(() => {
        ...
        // Start heart animation when transitioning to heart section
        if (toId === "heartSection") {
...
// Transition from flower to heart after 12 seconds
setTimeout(() => {
    switchSection("flowerSection", "heartSection");
}, 12000);

// Transition from heart to valentine after 12 + 15 = 27 seconds
setTimeout(() => {
    switchSection("heartSection", "valentineSection");
}, 27000);
